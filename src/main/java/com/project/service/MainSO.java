...
public class MainSO extends ItemSO {
	...
	public List<CourseItem> selectCourseItems(int memberId, int page) {
		int limit = 10;
		return courseDAO.selectCourseItems(memberId, this.getStartNum(page, limit), this.getEndNum(page, limit));
	}
