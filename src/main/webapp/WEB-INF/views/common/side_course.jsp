...
<aside class="sidebar course cffffff">
    <div class="side main">
        <div id="mobile">
            <div class="flex cen v h logo p50">
                ...
                <div class="mobile" id="hamburger">
                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="30px" height="30px"
        ...
        <ul class="menulist" id="pc">
            <a href="mypage.html">
                <li class="item grid cen h v">
                    <?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                    <svg class="icon" fill="#000000" width="30px" height="30px" viewBox="-1 0 19 19"
            ...
            <a href="main.html">
                <li class="item">
                    ...
                    <svg class="icon" fill="#000000" width="30px" height="30px" viewBox="0 0 512 512"
            ...
            <a href="checkin.html">
                <li class="item">
                    <?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                    <svg class="icon" width="30px" height="30px" viewBox="0 0 1024 1024" class="icon"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill="#000000"
            ...
            <a href="">
                <li class="item">
                    ...
                    <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                    <svg class="icon" fill="#000000" height="30px" width="30px" version="1.1" id="Filled_Icons"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                        y="0px" viewBox="0 0 24 24" enable-background="new 0 0 24 24" xml:space="preserve">
                        <g id="Add-User-Filled">
                            <path d="M21,14h-2v-3h-3V9h3V6h2v3h3v2h-3V14z" />
                            <path
                                d="M14,6c0,2.76-2.24,5-5,5S4,8.76,4,6s2.24-5,5-5S14,3.24,14,6z M17,23v-4c0-4.42-3.58-8-8-8h0c-4.42,0-8,3.58-8,8v4" />
                        </g>
                    </svg>
                </li>
            </a>
            <a href="">
                <li class="item">
                    ...
                    <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                    <svg class="icon" fill="#000000" height="30px" width="30px" version="1.1" id="Layer_1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        viewBox="0 0 455 455" xml:space="preserve">
                        <g>
                            <path
                                d="M227.5,455c27.922,0,52.019-16.353,63.255-40H164.245C175.481,438.647,199.578,455,227.5,455z" />
            ...
            <a href="">
                <li class="item">
                    ...
                    <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                    <svg class="icon" width="30px" height="30px" viewBox="0 0 48 48"
                        xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="side course">
        <div class="logo grid g20 mbe30">
            <a href="">
                <h1 class="f32 c87c791">CHECK</h1>
            </a>
            <h3 class="f24 c000000">HTML의 기초</h3>
            <hr>
        </div>
        <ul class="menulist">
            <a href="">
