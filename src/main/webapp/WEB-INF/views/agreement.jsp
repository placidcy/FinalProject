        ...
        <main>
            <div class="section">
                <form action="" method="GET">
                    ...
                    <input type="checkbox" name="allagree" id="allagree" required />
                    <label for="allagree" class="agreeBtn">전체 동의</label>
                </form>
            </div>
            <div class="section">
...
③ “몰”이 제3자에게 구매자의 개인정보를 취급할 수 있도록 업무를 위탁하는 경우에는 1) 개인정보 취급위탁을 받는 자, 2) 개인정보 취급위탁을 하는 업무의 내용을 구매자에게 알리고 동의를 받아야 합니다. (동의를 받은 사항이 변경되는 경우에도 같습니다.) 다만, 서비스제공에 관한 계약이행을 위해 필요하고 구매자의 편의증진과 관련된 경우에는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」에서 정하고 있는 방법으로 개인정보 취급방침을 통해 알림으로써 고지절차와 동의절차를 거치지 않아도 됩니다.
                ...
                <form action="" method="GET">
                    ...
                    <label for="memberagree" class="agreeBtn">동의함</label>
                </form>
            </div>
            <div class="section">
...
② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.    
                ...
                <form action="" method="GET">
                    ...
                    <label for="personalagree" class="agreeBtn">동의함</label>
                </form>
            </div>
            <hr>
            <button>다음</button>
